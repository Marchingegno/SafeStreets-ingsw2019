...
public class RetrieveViolationsManager implements MapUser {
	...
	private List<ViolationTypeEnum> violationTypeToRetrieve;
	 ...
	 */
	public void loadClusters(LatLng location, List<ViolationTypeEnum> violationTypes, Date intervalStartDate, Date intervalEndDate) {
